...
import github.qbic.darkflame.client.model.WatcherModel;

import com.mojang.blaze3d.vertex.VertexConsumer;
import com.mojang.blaze3d.vertex.PoseStack;

public class ObserverRenderer extends MobRenderer<ObserverEntity, LivingEntityRenderState, WatcherModel> {
	private ObserverEntity entity = null;

	public ObserverRenderer(EntityRendererProvider.Context context) {
		super(context, new AnimatedModel(context.bakeLayer(WatcherModel.LAYER_LOCATION)), 0.5f);
	...
	private static final class AnimatedModel extends WatcherModel {
		private ObserverEntity entity = null;
