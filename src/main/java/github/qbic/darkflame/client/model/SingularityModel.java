...
public class SingularityModel extends EntityModel<LivingEntityRenderState> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition singularity = partdefinition.addOrReplaceChild("singularity", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -110.0F, 0.0F, 0.0F, 3.1416F, 0.0F));
        ...
        PartDefinition head = singularity.addOrReplaceChild("head", CubeListBuilder.create(), PartPose.offset(0.0F, 1.0F, 0.0F));
        PartDefinition eye_r1 = head.addOrReplaceChild("eye_r1", CubeListBuilder.create().texOffs(176, 202).addBox(-15.4436F, -16.4436F, -1.0F, 32.0F, 32.0F, 0.0F, new CubeDeformation(0.1F)),
