...
public class ObserverEntity extends Monster {
	public static final EntityDataAccessor<Integer> DATA_despawnTimer = SynchedEntityData.defineId(ObserverEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_despawning = SynchedEntityData.defineId(ObserverEntity.class, EntityDataSerializers.BOOLEAN);
