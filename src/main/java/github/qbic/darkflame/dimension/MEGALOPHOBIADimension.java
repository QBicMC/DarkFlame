...
public class MEGALOPHOBIADimension {
    @EventBusSubscriber(bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
    public static class MEGALOPHOBIASpecialEffectsHandler {
        @SubscribeEvent
        public static void registerDimensionSpecialEffects(RegisterDimensionSpecialEffectsEvent event) {
            ...
            event.register(ResourceLocation.fromNamespaceAndPath(DarkFlame.MOD_ID, "megalophobia"), customEffect);
        }
    }
}
