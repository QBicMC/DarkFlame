...
//    private static final ModConfigSpec.IntValue AUTOSAVE_INTERVAL = BUILDER.comment("How often to autosave in ticks, 0 to disable autosave").defineInRange("autosaveInterval", 6000, 0, Integer.MAX_VALUE);
    private static final ModConfigSpec.IntValue CORRUPTION_SUPPRESSION = BUILDER.comment("Corruption will change a max of (ticks / this number) blocks when a chunk is loaded").defineInRange("corruptionSuppression", 10000, 0, Integer.MAX_VALUE);
